...
public class FilterConfig {
  ...
  public FilterRegistrationBean<ForwardedHeaderFilter> forwardedHeaderFilter(
    ...
    FilterRegistrationBean<ForwardedHeaderFilter> filterRegistrationBean =
        makeFilterRegistrationBean(beanFactory, ALL_URL_PATTERN, new ForwardedHeaderFilter());
  ...
  public FilterRegistrationBean<UserLoggingFilter> userLoggingFilter(
      AutowireCapableBeanFactory beanFactory) {
    FilterRegistrationBean<UserLoggingFilter> bean =
        makeFilterRegistrationBean(
  ...
  public FilterRegistrationBean<HttpRequestLoggingFilter> loggingFilter(
      AutowireCapableBeanFactory beanFactory) {
    FilterRegistrationBean<HttpRequestLoggingFilter> bean =
        makeFilterRegistrationBean(beanFactory, ALL_URL_PATTERN, new HttpRequestLoggingFilter());
  ...
  public FilterRegistrationBean<CommonsRequestLoggingFilter> commonsRequestLoggingFilter(
    ...
    FilterRegistrationBean<CommonsRequestLoggingFilter> bean =
        makeFilterRegistrationBean(beanFactory, ALL_URL_PATTERN, filter);
    bean.setOrder(getFilterOrder(FilterOrder.COMMONS_REQUEST_LOGGING));
    return bean;
  }

  private <T extends Filter> FilterRegistrationBean<T> makeFilterRegistrationBean(
      AutowireCapableBeanFactory beanFactory, String urlPatterns, T filter) {
